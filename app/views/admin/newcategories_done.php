...
<div class="tableoptions">
    ...
    <a href="<?= URLROOT;?>/admins/newproductcategories_done"  class="delete-blue tboption" style=" background-color: var(--blue);color: #fff9f8;"> <i class="far fa-check-circle" style="color: #fff9f8"></i> Done</a>
