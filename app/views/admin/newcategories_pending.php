...
<div class="tableoptions">
    ...
    <a href="<?= URLROOT;?>/admins/newproductcategories_pending" class="delete-green tboption" style="background-color: var(--green);color: #fff9f8;"><i class="fas fa-hourglass-end" style="color:#fff9f8"></i> Pending</a>
