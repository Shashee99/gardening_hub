...
<section id="side">
        ...
        <div class="items">
            ...
            <li><img src="<?php echo URLROOT; ?>/img/customer/advisor.png" alt=""><a href="<?php echo URLROOT; ?>/advisors/viewAdvisors">Advisors</a></li>
            <li><img src="<?php echo URLROOT; ?>/img/customer/agri_center.png" alt=""><a href="<?php echo URLROOT; ?>/agriCenters/viewAgriCenters">Agri Centers</a></li>
