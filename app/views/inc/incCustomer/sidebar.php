...
<section id="side">
        ...
        <div class="items">
            ...
            <li><img src="<?php echo URLROOT; ?>/img/customer/product.png" alt=""><a href="./product.php">Products</a></li>
            <li><img src="<?php echo URLROOT; ?>/img/customer/wishlist.png" alt=""><a href="./wishlist.php">Wishlist</a></li>
            <li><img src="<?php echo URLROOT; ?>/img/customer/advisor.png" alt=""><a href="./advisor.php">Advisors</a></li>
            <li><img src="<?php echo URLROOT; ?>/img/customer/agri_center.png" alt=""><a href="./agricenter.php">Agriculture Centers</a></li>
            <li><img src="<?php echo URLROOT; ?>/img/customer/harvest.png" alt=""><a href="<?php echo URLROOT; ?>/harvests/viewAddMyHarvest">Harvest</a></li>
            <li><img src="<?php echo URLROOT; ?>/img/customer/progress.png" alt=""><a href="./progress.php">Progress</a></li>
            <li><img src="<?php echo URLROOT; ?>/img/customer/problem.png" alt=""><a href="./problem.php">Problem Forum</a></li>
            <li><img src="<?php echo URLROOT; ?>/img/customer/chat.png" alt=""><a href="./chat.php">Chat Forum</a></li>
            <li><img src="<?php echo URLROOT; ?>/img/customer/new.png" alt=""><a href="<?php echo URLROOT; ?>/newTechs/viewNewTech">New Technologies</a></li>
